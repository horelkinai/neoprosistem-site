...
## 1. Яндекс.Метрика
**Статус: ПОДКЛЮЧЕНА ✅** — счётчик `111419153`, сниппет стоит на всех 5 страницах перед `</head>` (08.08.2026).

Первоначальная настройка (если нужен второй счётчик): заведите счётчик: https://metrika.yandex.ru/ (нужен аккаунт Яндекса).
